...
<div class="login-box">
  ...
  <div class="card card-outline card-danger">
    <div class="card-header text-center">
      <a href="../public/templeates/AdminLTE-3.2.0/index2.html" class="h1"><b>PERSONAL NO</b>AUTORIZADO</a>
    </div>
    <center>
    ...
    <div class="card-body">
    <center>
      <p class="login-box-msg"><h4>Ingrese datos de supervisor</h4></p>
      </center>
      <form action="../app/controllers/login/ingreso.php" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-12">
          <a href="../empleados/create.php" class="btn btn-outline-success btn-block">Ingresar</a>
            <a href="../index.php" class="btn btn-outline-warning btn-block">Regresar</a>
          </div>
          <!-- /.col -->
        </div>
      </form>
