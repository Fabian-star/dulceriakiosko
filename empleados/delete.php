...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Eliminacion de Empleado</h1>
          </div><!-- /.col -->
            ...
            <div class="row">
              ...
              <div class="card card-outline card-danger">
                        <div class="card-header">
                            <h3 class="card-title">¿Seguro de eliminar al Empleado?</h3>
                        ...
                        <div class="card-body" style="display: block;">
                          <div class="row">
                            <div class="col-md-12">
                            <form action="../app/controllers/empleados/delete.php" method="post">
                                <input type="text" name="rfcEmpleado" value="<?php echo $rfcEmpleado_empleado_get;?>" hidden>
