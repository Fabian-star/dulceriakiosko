                ...
                <div class="col-md-14">
                  ...
                  <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <center>
                                          <div class=""btn-group>
                                            <a href="show.php?rfcEmpleado=<?php echo $rfcEmpleado_empleado;?>" type="button" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                                            <a href="update.php?rfcEmpleado=<?php echo $rfcEmpleado_empleado;?>" type="button" class="btn btn-success"><i class="fa fa-pencil-alt"></i></a>
                                            <a href="delete.php?rfcEmpleado=<?php echo $rfcEmpleado_empleado;?>" type="button" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                          </center>
                                          </div>
                                        </td>
                                    </tr>
